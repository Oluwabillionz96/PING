  ...
  return (
    <section className="container">
      ...
      <div className='flexie'>
        <div>
          <input type="email" name="email" id="name" autoFocus/>
          <button onClick={click}>Notify me</button>
        </div>
...
function click(){
  ...
  let email = input.value === '' || input.value.includes('@') === false || input.value.includes('.com') === false?function(){
      error.style.display = 'block';
      input.style.borderColor = 'hsl(354, 100%, 66%)';
      input.style.outlineColor = 'hsl(354, 100%, 66%)';
  }:function(){
    input.value = '';
         input.style.borderColor = 'rgb(0,255,0)';
      input.style.outlineColor = 'rgb(0,255,0)';
  };
  email();
}
